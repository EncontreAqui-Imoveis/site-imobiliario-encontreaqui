...
export default function ProposalWizardPage() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center pt-20">
                <div className="text-center space-y-4 max-w-md">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-slate-100 dark:text-slate-100">Acesso restrito a corretores</h1>
                    <p className="text-gray-500 dark:text-slate-400 dark:text-slate-400">Apenas corretores podem gerar propostas.</p>
        ...
        return (
            <div className="min-h-screen flex items-center justify-center pt-20">
                <div className="text-center space-y-4">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-slate-100 dark:text-slate-100">{loadError || 'Imóvel não especificado'}</h1>
        ...
        return (
            <div className="min-h-screen flex items-center justify-center pt-20">
                <div className="space-y-3 text-center">
                    ...
                    <p className="text-sm text-gray-500 dark:text-slate-400 dark:text-slate-400">Carregando imóvel...</p>
                </div>
            </div>
        )
    }
    ...
    if (!canGenerateForProperty) {
        return (
            <div className="min-h-screen flex items-center justify-center pt-20">
                <div className="space-y-3 text-center">
                    <Loader2 className="w-6 h-6 animate-spin text-primary-500 mx-auto" />
                    <p className="text-sm text-gray-500 dark:text-slate-400 dark:text-slate-400">Redirecionando para o imóvel...</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-800 dark:bg-slate-800 pt-16 lg:pt-20">
            <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
                {/* Breadcrumbs */}
                <nav className="flex items-center gap-2 text-sm text-gray-500 dark:text-slate-400 dark:text-slate-400 mb-6">
                    ...
                    <ChevronRight className="w-4 h-4" />
                    <span className="text-gray-900 dark:text-slate-100 dark:text-slate-100 font-medium">Gerar Proposta</span>
                </nav>
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100 dark:text-slate-100">Gerar Proposta</h1>
                    </div>
                ...
                {/* Step Content */}
                <div className="bg-white dark:bg-slate-900 dark:bg-slate-900 rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 dark:border-slate-700 dark:border-slate-700 overflow-hidden">
                    {step === 0 ? (
                        /* ═══ STEP 1: Client Data ═══ */
                        <div className="p-6 space-y-6">
                            <div className="flex items-center gap-2 text-lg font-bold text-gray-900 dark:text-slate-100 dark:text-slate-100">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 dark:text-slate-300 mb-1">Nome do Cliente *</label>
                                    <input
                                        type="text"
                                        value={clientName}
                                        onChange={e => setClientName(e.target.value)}
                                        maxLength={120}
                                        className="w-full px-4 py-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all"
                                        placeholder="Nome completo do comprador"
                                    />
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 dark:text-slate-300 mb-1">CPF *</label>
                                    <input
                                        type="text"
                                        value={clientCpf}
                            ...
                            {/* Broker selection */}
                            <div className="pt-4 border-t border-gray-100 dark:border-slate-700 dark:border-slate-700">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm font-medium text-gray-700 dark:text-slate-300 dark:text-slate-300">Eu sou o corretor vendedor</span>
                                </label>
                                <p className="text-xs text-gray-400 dark:text-slate-500 dark:text-slate-500 mt-2">
                                    ...
                                    <div className="mt-4 space-y-2">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                maxLength={120}
                                                className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                                                placeholder="Buscar por nome, email ou CRECI"
                                            />
                                        </div>

                                        {isSearching && (
                                            <div className="h-1 bg-gray-100 dark:bg-slate-800 dark:bg-slate-800 rounded-full overflow-hidden">
                                        ...
                                        {brokerResults.length > 0 && !selectedBroker && (
                                            <div className="border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl divide-y divide-gray-100 overflow-hidden">
                                                {brokerResults.map(broker => (
                                                    ...
                                                    >
                                                        <p className="text-sm font-semibold text-gray-900 dark:text-slate-100 dark:text-slate-100">{broker.name}</p>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            {/* Summary */}
                            <div className="bg-gray-50 dark:bg-slate-800 dark:bg-slate-800 rounded-xl p-4 space-y-2 border border-gray-100 dark:border-slate-700 dark:border-slate-700">
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500 dark:text-slate-400 dark:text-slate-400">Valor do Imóvel</span>
                                    <span className="font-bold text-gray-900 dark:text-slate-100 dark:text-slate-100">{formatPrice(propertyValue)}</span>
                                </div>
                                ...
                                {Object.entries(payments).map(([key, field]) => {
                                    ...
                                    return (
                                        <div key={key} className="space-y-1">
                                            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 dark:text-slate-300">{label}</label>
                                            <div className="flex gap-2">
                                                <div className="flex-1 relative">
                                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-slate-500 dark:text-slate-500 text-sm">
                                                        {field.unit === 'percent' ? '%' : ''}
                                                    </span>
                                                    {field.unit === 'reais' ? (
                                                        <CurrencyInput
                                                            ...
                                                            className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all"
                                                            placeholder="R$ 0,00"
                                                        />
                                                    ) : (
                                                        <input
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors flex items-center gap-1 text-sm font-medium text-gray-600 dark:text-slate-300 dark:text-slate-300"
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-3 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl hover:bg-accent-50 hover:border-accent-200 transition-colors text-gray-500 dark:text-slate-400 dark:text-slate-400 hover:text-accent-600"
                                                    title="Preencher com restante"
                                                >
                                                    <Wand2 className="w-4 h-4" />
                                                </button>
                                            </div>
                                            <p className="text-xs text-gray-400 dark:text-slate-500 dark:text-slate-500">{helper}</p>
                                        </div>
                                    )
                                })}
                            </div>
                    ...
                    <div className="p-6 pt-0 flex gap-3">
                        {step > 0 && (
                            <button
                                ...
                                className="flex-1 flex items-center justify-center gap-2 py-4 border-2 border-gray-200 dark:border-slate-700 dark:border-slate-700 text-gray-700 dark:text-slate-300 dark:text-slate-300 font-bold rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors disabled:opacity-50"
                            >
