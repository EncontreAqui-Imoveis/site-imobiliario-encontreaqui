...
export default function ProposalWizardPage() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center pt-20">
                <div className="text-center space-y-4 max-w-md">
                    ...
                    <p className="text-gray-500 dark:text-slate-400">Apenas corretores podem gerar propostas.</p>
        ...
        return (
            <div className="min-h-screen flex items-center justify-center pt-20">
                <div className="space-y-3 text-center">
                    ...
                    <p className="text-sm text-gray-500 dark:text-slate-400">Carregando imóvel...</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-16 dark:bg-slate-800 lg:pt-20">
            <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
                ...
                <nav className="mb-6 flex items-center gap-2 text-sm text-gray-500 dark:text-slate-400">
                    ...
                    <ChevronRight className="w-4 h-4" />
                    <span className="font-medium text-gray-900 dark:text-slate-100">Gerar Proposta</span>
                </nav>
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">Gerar Proposta</h1>
                    </div>
                ...
                {/* Step Content */}
                <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-lg shadow-gray-200/50 dark:border-slate-700 dark:bg-slate-900">
                    {step === 0 ? (
                        /* ═══ STEP 1: Client Data ═══ */
                        <div className="p-6 space-y-6">
                            <div className="flex items-center gap-2 text-lg font-bold text-gray-900 dark:text-slate-100">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-slate-300">Nome do Cliente *</label>
                                    <input
                                        type="text"
                                        value={clientName}
                                        onChange={e => setClientName(e.target.value)}
                                        maxLength={120}
                                        className="w-full rounded-xl border border-gray-200 px-4 py-3 outline-none transition-all focus:border-transparent focus:ring-2 focus:ring-primary-500 dark:border-slate-700"
                                        placeholder="Nome completo do comprador"
                                    />
                                </div>

                                <div>
                                    <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-slate-300">CPF *</label>
                                    <input
                                        type="text"
                                        value={clientCpf}
                            ...
                            <div className="border-t border-gray-100 pt-4 dark:border-slate-700">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm font-medium text-gray-700 dark:text-slate-300">Eu sou o corretor vendedor</span>
                                </label>
                                    ...
                                    <div className="mt-4 space-y-2">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                maxLength={120}
                                                className="w-full rounded-xl border border-gray-200 py-3 pl-10 pr-4 outline-none focus:border-transparent focus:ring-2 focus:ring-primary-500 dark:border-slate-700"
                                                placeholder="Buscar por nome, email ou CRECI"
                                            />
                                        </div>

                                        {isSearching && (
                                            <div className="h-1 overflow-hidden rounded-full bg-gray-100 dark:bg-slate-800">
                                        ...
                                        {brokerResults.length > 0 && !selectedBroker && (
                                            <div className="overflow-hidden rounded-xl border border-gray-200 divide-y divide-gray-100 dark:border-slate-700">
                                                {brokerResults.map(broker => (
                                                    ...
                                                    >
                                                        <p className="text-sm font-semibold text-gray-900 dark:text-slate-100">{broker.name}</p>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            {/* Summary */}
                            <div className="space-y-2 rounded-xl border border-gray-100 bg-gray-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500 dark:text-slate-400">Valor do Imóvel</span>
                                    <span className="font-bold text-gray-900 dark:text-slate-100">{formatPrice(propertyValue)}</span>
                                </div>
                                        ...
                                        <div key={key} className="space-y-1">
                                            ...
                                            <div className="flex gap-2">
                                                <div className="flex-1 relative">
                                                    ...
                                                    {field.unit === 'reais' ? (
                                                        <CurrencyInput
                                                            ...
                                                            className="w-full rounded-xl border border-gray-200 py-3 pl-10 pr-4 outline-none transition-all focus:border-transparent focus:ring-2 focus:ring-primary-500 dark:border-slate-700"
                                                            placeholder="R$ 0,00"
                                                        />
                                                    ) : (
                                                        <input
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-1 rounded-xl border border-gray-200 px-3 py-3 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
                                                ...
                                                <button
                                                    ...
                                                    className="rounded-xl border border-gray-200 px-3 py-3 text-gray-500 transition-colors hover:border-accent-200 hover:bg-accent-50 hover:text-accent-600 dark:border-slate-700 dark:text-slate-400"
                                                    title="Preencher com restante"
                                                >
                                                    <Wand2 className="w-4 h-4" />
                                                </button>
                                            </div>
                                            <p className="text-xs text-gray-400 dark:text-slate-500">{helper}</p>
                                        </div>
                                    )
                                })}
                            </div>
                    ...
                    <div className="p-6 pt-0 flex gap-3">
                        {step > 0 && (
                            <button
                                ...
                                className="flex flex-1 items-center justify-center gap-2 rounded-xl border-2 border-gray-200 py-4 font-bold text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
                            >
