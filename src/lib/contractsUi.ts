    ...
    switch (status) {
        case 'AWAITING_DOCS':
            return {
                ...
                chipClass: 'bg-amber-50 text-amber-700 dark:bg-amber-900/40 dark:text-amber-200',
        ...
        case 'IN_DRAFT':
            return {
                label: 'Em minuta',
                chipClass: 'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-200',
        ...
        case 'AWAITING_SIGNATURES':
            return {
                ...
                chipClass: 'bg-violet-50 text-violet-700 dark:bg-violet-900/40 dark:text-violet-200',
        ...
        default:
            return {
                label: status,
                chipClass: 'bg-slate-50 text-slate-700 dark:bg-slate-800 dark:text-slate-200',
