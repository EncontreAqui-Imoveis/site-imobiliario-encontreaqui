...
export default function PropertyGrid({
    ...
    if (isLoading) {
        return (
            ...
            >
                {[...Array(8)].map((_, i) => (
                    <div key={i} className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-gray-100 dark:border-slate-700 shadow-sm animate-pulse">
    ...
    if (properties.length === 0) {
        return (
            <section
                ...
                className="text-center py-12 sm:py-16 px-4 bg-white dark:bg-slate-900 rounded-3xl border border-gray-100 dark:border-slate-700 shadow-sm"
            >
